...
class Fans extends Component {
  ...
  render() {
    ...
    return (
      <SvgIcon {...props} color={color} viewBox="0 0 240 240">
        <g>
          <path fill={trunkColor} d="M205.7,163c0,0-0.1,0.1-0.4,0.4c-0.2,0.3-0.6,0.7-1.1,1.2c-1,1-2.5,2.4-4.6,3.9c-1.1,0.8-2.2,1.6-3.6,2.4
          ...
          <path fill={wingTopColor} d="M129.4,105.9c0.2-0.1,0.4-0.3,0.6-0.4c16.1-12.8,28.3-28.6,36.5-46c0.6-1.3-0.5-2.8-2-2.5
          ...
          <path fill={wingButtonColor} d="M185.4,107.7c-17.8-4.6-36.8-5.3-56-1.7c-15.9,12.5-33.9,20.7-52.5,24.8c-0.8,0.2-1.5-0.2-1.9-0.8
          ...
          <path fill={tailColor} d="M216.6,160.2c-2,3.1-6.5,3.3-9.4,0.9c-2.9-2.3-3.3-6.5-0.9-9.4c1.9-2.3,8.6-3.5,11-3.9
